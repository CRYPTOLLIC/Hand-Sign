...
template = cv2.imread(
    "C:/Users/vivek nishad/OneDrive/Desktop/Vivek nishad/hand_template.png", 
...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks and not palm_detected:
...
if palm_detected:
    video = cv2.VideoCapture('C:/Users/vivek nishad/OneDrive/Desktop/Vivek nishad/vid.mp4')
